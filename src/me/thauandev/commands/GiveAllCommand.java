...
public class GiveAllCommand implements CommandExecutor{
	...
	public boolean onCommand(CommandSender Sender, Command Cmd, String Label, String[] Args) {
		...
		if(Args[0].equalsIgnoreCase("utlimate")){
			...
			Bukkit.broadcastMessage("§c§lSPEED§f§lMC §7O Player §a(" + p.getName() + ") §7liberou o §d§lULTIMATE §7para §9§lTODOS§f.");
				pro = true;
				return true;
			}
		}
		if(Args[0].equalsIgnoreCase("premium")){
			...
			Bukkit.broadcastMessage("§c§lSPEED§f§lMC §7O Player §a(" + p.getName() + ") §7liberou o §6§lPREMIUM §7para §9§lTODOS§f.");
				mvp = true;
				return true;
			}
		}
        if(Args[0].equalsIgnoreCase("winner")){
			...
			Bukkit.broadcastMessage("§c§lSPEED§f§lMC §7O Player §a(" + p.getName() + ") §7liberou o §2§lWINNER §7para §9§lTODOS§f.");
				winner = true;
				return true;
			}
		}
		if(Args[0].equalsIgnoreCase("light")){
			...
			Bukkit.broadcastMessage("§c§lSPEED§f§lMC §7O Player §a(" + p.getName() + ") §7liberou o §a§lLIGHT §7para §9§lTODOS§f.");
				light = true;
				return true;
			}
		}
		if(Args[0].equalsIgnoreCase("fullkit")){
			...
			Bukkit.broadcastMessage("§c§lSPEED§f§lMC §7O Player §a(" + p.getName() + ") §7liberou o §e§lFULLKIT §7para §9§lTODOS§f!");
				fullkit = true;
				return true;
			}
		}
