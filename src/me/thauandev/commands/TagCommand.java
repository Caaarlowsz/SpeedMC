...
public class TagCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if ((cmd.getName().equalsIgnoreCase("tag"))) {
			...
			if (args[0].equalsIgnoreCase("builder")) {
				if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Mod+")
			...
			if (args[0].equalsIgnoreCase("youtuber+")) {
				if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Gerente")
						|| cfGrupo.ChecarGrupo(p, "Admin") || cfGrupo.ChecarGrupo(p, "Youtuber+")) {
					p.sendMessage(" ");
			...
			if (args[0].equalsIgnoreCase("platinum")) {
				if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Gerente")
						|| cfGrupo.ChecarGrupo(p, "Admin") || cfGrupo.ChecarGrupo(p, "S-Pro")) {
					p.sendMessage(" ");
			...
			if (args[0].equalsIgnoreCase("ultimate")) {
				if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Gerente")
						...
						|| cfGrupo.ChecarGrupo(p, "Pro") || cfGrupo.ChecarGrupo(p, "Mod+")
			...
			if (args[0].equalsIgnoreCase("premium")) {
				if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Builder")
						...
						|| cfGrupo.ChecarGrupo(p, "Trial") || cfGrupo.ChecarGrupo(p, "Mvp")
			...
			if (args[0].equalsIgnoreCase("light")) {
				if (cfGrupo.ChecarGrupo(p, "Dono") || cfGrupo.ChecarGrupo(p, "Builder")
						|| cfGrupo.ChecarGrupo(p, "Gerente") || cfGrupo.ChecarGrupo(p, "Admin")
						|| cfGrupo.ChecarGrupo(p, "Light") || cfGrupo.ChecarGrupo(p, "Pro")
						|| cfGrupo.ChecarGrupo(p, "Mvp") || cfGrupo.ChecarGrupo(p, "Youtuber")
