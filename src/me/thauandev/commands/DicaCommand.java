	...
	public boolean onCommand(CommandSender Sender, Command Cmd, String Label, String[] Args) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(Main.getPlugin(), new Runnable() {
          ...
          for (Player s : Bukkit.getOnlinePlayers()) {
      		if((cfGrupo.ChecarGrupo(s, "Dono") || ((cfGrupo.ChecarGrupo(s, "Admin") || ((cfGrupo.ChecarGrupo(s, "Gerente") || ((cfGrupo.ChecarGrupo(s, "Mod+") || ((cfGrupo.ChecarGrupo(s, "Mod") || ((cfGrupo.ChecarGrupo(s, "Youtuber+") || ((cfGrupo.ChecarGrupo(s, "Trial"))))))))))))))){
