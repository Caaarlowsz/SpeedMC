		...
		if (cmd.getName().equalsIgnoreCase("givekit")) {
			...
			if (args.length == 2) {
				...
				if (kit.equalsIgnoreCase("archer")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lARCHER §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("kangaroo")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lKANGAROO §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("fisherman")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lFISHERMAN §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("anchor")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lANCHOR §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("cactus")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lCACTUS §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("ninja")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lNINJA §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("antitower")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lANTITOWER §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("phantom")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lPHANTOM §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("grappler")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lGRAPPLER §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("viper")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lVIPER §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("snail")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lSNAIL §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("timelord")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lTIMELORD §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("switcher")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lSWITCHER §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("gladiator")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lGLADIATOR §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("stomper")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lSTOMPER §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("magma")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lMAGMA §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("grandpa")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lGRANDPA §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("ajnin")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lAJNIN §7para o jogador: §c§l" + k.getName());
				...
				if (kit.equalsIgnoreCase("firelauncher")) {
					p.sendMessage("§c§lSPEED§f§lMC §7Você aplicou o kit §c§lFIRELAUNCHER §7para o jogador: §c§l"
							+ k.getName());
				...
				if (kit.equalsIgnoreCase("strong")) {
					p.sendMessage(
							"§c§lSPEED§f§lMC §7Você aplicou o kit §c§lSTRONG §7para o jogador: §c§l" + k.getName());
