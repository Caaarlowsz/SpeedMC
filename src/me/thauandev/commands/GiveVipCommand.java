				...
				if((sender instanceof Player)) {
					if(k == null) {
						...
						if(arg.equalsIgnoreCase("Light")) {
							p.sendMessage("§c§lSPEED§f§lMC §7» §fVocê aplicou o VIP §a§lLIGHT §fpara o JOGADOR: §a§l" + off.getName());
						...
						if(arg.equalsIgnoreCase("premium")) {
							p.sendMessage("§c§lSPEED§f§lMC §7» §fVocê aplicou o VIP §6§lPREMIUM §fpara o JOGADOR: §6§l" + off.getName());
						...
						if(arg.equalsIgnoreCase("ultimate")) {
							p.sendMessage("§c§lSPEED§f§lMC §7» §fVocê aplicou o VIP §d§lULTIMATE §fpara o JOGADOR: §d§l" + off.getName());
					...
					if(k != null) {
						if(arg.equalsIgnoreCase("light")) {
							p.sendMessage("§c§lSPEED§f§lMC §7» §fVocê aplicou o VIP §a§lLIGHT §fpara o JOGADOR: §a§l" + k.getName());
							
							k.sendMessage("§eVocê recebeu o VIP Light Seu grupo foi alterado para LIGHT.");
						...
						if(arg.equalsIgnoreCase("premium")) {
							p.sendMessage("§c§lSPEED§f§lMC §7» §fVocê aplicou o VIP §6§lPREMIUM §fpara o JOGADOR: §9§l" + k.getName());
							
							k.sendMessage("§eVocê recebeu o VIP premium. Seu grupo foi alterado para premium.");
							
							TituloAPI.MandarTitulo(k, "§6§lPREMIUM");
							TituloAPI.MandarSubTitulo(k, "§7Você recebeu o VIP §6§lPREMIUM");
						...
						if(arg.equalsIgnoreCase("ultimate")) {
							p.sendMessage("§c§lSPEED§f§lMC §7» §fVocê aplicou o VIP §d§lULTIMATE §fpara o JOGADOR: §6§l" + k.getName());
							
							k.sendMessage("§eVocê recebeu o VIP Ultimate. Seu grupo foi alterado para Ultimate.");
							
							TituloAPI.MandarTitulo(k, "§d§lULTIMATE");
							TituloAPI.MandarSubTitulo(k, "§7Você recebeu o VIP §d§lULTIMATE");
