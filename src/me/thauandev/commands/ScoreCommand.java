	...
	public boolean onCommand(CommandSender Sender, Command Cmd, String Label, String[] Args) {
		...
		if (Cmd.getName().equalsIgnoreCase("score")) {
			...
			if (sScoreAPI.Score.contains(p)) {
				p.sendMessage("�c�lSPEED�f�lMC �fA scoreboard foi desativada, para ativ�-la novamente use �c/score");
				...
				p.sendMessage("�c�lSPEED�f�lMC �fA scoreboard foi ativada, para desativ�-la novamente use �c/score");
