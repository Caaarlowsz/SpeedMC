...
public class GroupSetCommand implements CommandExecutor{
		...
		if(Cmd.getName().equalsIgnoreCase("setgroup")){
			...
			if(target == null){
				...
				if(Args[1].equalsIgnoreCase("membro")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §7§lMEMBRO");
				...
				if(Args[1].equalsIgnoreCase("winner")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §2§lWINNER");
				...
				if(Args[1].equalsIgnoreCase("light")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §a§lLIGHT");
				...
				if(Args[1].equalsIgnoreCase("premium")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §6§lPREMIUM");
				...
				if(Args[1].equalsIgnoreCase("platinum")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §e§lPLATINUM");
				...
				if(Args[1].equalsIgnoreCase("ultimate")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §d§lULTIMATE");
				...
				if(Args[1].equalsIgnoreCase("youtuber")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §b§lYOUTUBER");
				...
				if(Args[1].equalsIgnoreCase("youtuber+")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §3§lYOUTUBER+");
				...
				if(Args[1].equalsIgnoreCase("ajudante")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §9§lAJUDANTE");
				...
				if(Args[1].equalsIgnoreCase("builder")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §2§lBUILDER");
				...
				if(Args[1].equalsIgnoreCase("trial")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §5§lTRIAL");
				...
				if(Args[1].equalsIgnoreCase("mod")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §5§lMOD");
				...
				if(Args[1].equalsIgnoreCase("admin")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §c§lADMIN");
				...
				if(Args[1].equalsIgnoreCase("gerente")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §c§lGERENTE");
				...
				if(Args[1].equalsIgnoreCase("dono")){
					...
					p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §4§lDONO");
			...
			if(Args[1].equalsIgnoreCase("membro")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §7§lMEMBRO");
	...
	target.chat("/tag normal");
			...
			if(Args[1].equalsIgnoreCase("winner")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §2§lWINNER");
	...
	target.chat("/tag winner");
			...
			if(Args[1].equalsIgnoreCase("light")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §a§lLIGHT");
			...
			if(Args[1].equalsIgnoreCase("premium")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §6§lPREMIUM");
			...
			if(Args[1].equalsIgnoreCase("ultimate")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §d§lULTIMATE");
			...
			if(Args[1].equalsIgnoreCase("youtuber")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §b§lYOUTUBER");
			...
			if(Args[1].equalsIgnoreCase("youtuber+")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §3§lYOUTUBER+");
			...
			if(Args[1].equalsIgnoreCase("builder")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §e§lBUILDER");
			...
			if(Args[1].equalsIgnoreCase("ajudante")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §9§lAJUDANTE");
			...
			if(Args[1].equalsIgnoreCase("trial")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §5§lTRIAL");
			...
			if(Args[1].equalsIgnoreCase("admin")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §c§lADMIN");
			...
			if(Args[1].equalsIgnoreCase("gerente")){
				...
				p.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §c§lGERENTE");
		...
		if(target == null){
			...
			if(Args[1].equalsIgnoreCase("membro")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §7§lMEMBRO");
			...
			if(Args[1].equalsIgnoreCase("winner")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §2§lWINNER");
			...
			if(Args[1].equalsIgnoreCase("light")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §a§lLIGHT");
			...
			if(Args[1].equalsIgnoreCase("premium")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §6§lPREMIUM");
			...
			if(Args[1].equalsIgnoreCase("platinum")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §e§lPLATINUM");
			...
			if(Args[1].equalsIgnoreCase("ultimate")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §d§lULTIMATE");
			...
			if(Args[1].equalsIgnoreCase("youtuber")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §b§lYOUTUBER");
			...
			if(Args[1].equalsIgnoreCase("youtuber+")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §3§lYOUTUBER+");
			...
			if(Args[1].equalsIgnoreCase("builder")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §e§lBUILDER");
			...
			if(Args[1].equalsIgnoreCase("helper")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §9§lAJUDANTE");
			...
			if(Args[1].equalsIgnoreCase("trial")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §5§lTRIAL");
			...
			if(Args[1].equalsIgnoreCase("mod")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §5§lMOD");
			...
			if(Args[1].equalsIgnoreCase("admin")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §c§lADMIN");
			...
			if(Args[1].equalsIgnoreCase("gerente")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §c§lGERENTE");
			...
			if(Args[1].equalsIgnoreCase("dono")){
				...
				Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + targetoff.getName() + " §7para: §4§lDONO");
		...
		if(Args[1].equalsIgnoreCase("membro")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §7§lMEMBRO");
...
if(Args[1].equalsIgnoreCase("membro")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §2§lWINNER");
		...
		if(Args[1].equalsIgnoreCase("light")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §a§lLIGHT");
		...
		if(Args[1].equalsIgnoreCase("premium")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §6§lPREMIUM");
		...
		if(Args[1].equalsIgnoreCase("platinum")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §e§lPLATINUM");
		...
		if(Args[1].equalsIgnoreCase("ultimate")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §d§lULTIMATE");
		...
		if(Args[1].equalsIgnoreCase("youtuber")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §b§lYOUTUBER");
		...
		if(Args[1].equalsIgnoreCase("youtuber+")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §3§lYOUTUBER+");
		...
		if(Args[1].equalsIgnoreCase("builder")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §e§lBUILDER");
		...
		if(Args[1].equalsIgnoreCase("ajudante")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §9§lAJUDANTE");
		...
		if(Args[1].equalsIgnoreCase("trial")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §5§lTRIAL");
		...
		if(Args[1].equalsIgnoreCase("mod")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §5§lMOD");
		...
		if(Args[1].equalsIgnoreCase("admin")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §c§lADMIN");
		...
		if(Args[1].equalsIgnoreCase("gerente")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §c§lGERENTE");
		...
		if(Args[1].equalsIgnoreCase("dono")){
			...
			Sender.sendMessage("§3§lGROUPSET §7Voce Alterou o grupo de §c" + target.getName() + " §7para: §4§lDONO");
