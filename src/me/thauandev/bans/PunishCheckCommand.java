...
public class PunishCheckCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("bancheck")) {
			...
			if (args.length == 0) {
				API.sendMsg(jogador,
						"§b§lSLASH§f§lMC §fO §b/bancheck §fserve para checar o histórico de punições de um certo jogador. Use: §b/bancheck (JOGADOR)§f!");
			...
			if (check == null) {
				...
				if (Config.getConfig().getJogadores().get("Jogadores." + checkoff.getUniqueId()) != null) {
					...
					if (Config.getConfig().getBans().get("Bans." + checkoff.getUniqueId()) != null
						...
						API.sendMsg(jogador, "§7Banido por: §5§l"
								+ Config.getConfig().getBans().get("Bans." + checkoff.getUniqueId() + ".Banido por"));
						API.sendMsg(jogador, "§7Motivo: §6§l"
								+ Config.getConfig().getBans().get("Bans." + checkoff.getUniqueId() + ".Motivo"));
						API.sendMsg(jogador, "§7Data do banimento: §a" + Config.getConfig().getBans()
					...
					if (Config.getConfig().getBans().get("Bans." + checkoff.getUniqueId()) == null
						...
						API.sendMsg(jogador, "§7Banido por: §5§l" + Config.getConfig().getTempBans()
								.get("TempBans." + checkoff.getUniqueId() + ".Banido por"));
						API.sendMsg(jogador, "§7Motivo: §6§l" + Config.getConfig().getTempBans()
								.get("TempBans." + checkoff.getUniqueId() + ".Motivo"));
						API.sendMsg(jogador, "§7Expira em: §a" + Config.getConfig().getTempBans()
								.get("TempBans." + checkoff.getUniqueId() + ".Tempo do Ban"));
						API.sendMsg(jogador, "§7Data do banimento: §e" + Config.getConfig().getTempBans()
								.get("TempBans." + checkoff.getUniqueId() + ".Data do banimento"));
					...
					if (Config.getConfig().getBans().get("Bans." + checkoff.getUniqueId()) == null
						...
						API.sendMsg(jogador, "§7Banido por: §e§l" + Config.getConfig().getIpBans()
								.get("IPBans." + checkoff.getUniqueId() + ".Banido por"));
						API.sendMsg(jogador, "§7Motivo: §6§l"
								+ Config.getConfig().getIpBans().get("IPBans." + checkoff.getUniqueId() + ".Motivo"));
						API.sendMsg(jogador, "§7Data do banimento: §a" + Config.getConfig().getIpBans()
								.get("IPBans." + checkoff.getUniqueId() + ".Data do banimento"));
						API.sendMsg(jogador, "§7IP banido: §8" + Config.getConfig().getIpBans()
			...
			if (Config.getConfig().getBans().get("Bans." + check.getUniqueId()) != null
				...
				API.sendMsg(jogador, "§7Data do banimento: §a"
			...
			if (Config.getConfig().getBans().get("Bans." + check.getUniqueId()) == null
				...
				API.sendMsg(jogador, "§7Expira em: §a"
			...
			if (Config.getConfig().getBans().get("Bans." + check.getUniqueId()) == null
				...
				API.sendMsg(jogador, "§7IP banido: §8"
						+ Config.getConfig().getIpBans().get("IPBans." + check.getUniqueId() + ".IP do Jogador"));
				return true;
			}
		}
		if (cmd.getName().equalsIgnoreCase("mutecheck")) {
			if ((!cfGrupo.ChecarGrupo(jogador, "Dono")
					&& (!cfGrupo.ChecarGrupo(jogador, "Gerente") && (!cfGrupo.ChecarGrupo(jogador, "Admin")
			...
			if (check == null) {
				...
				if (Config.getConfig().getJogadores().get("Jogadores." + checkoff.getUniqueId()) != null) {
					...
					if (Config.getConfig().getMute().get("Mute." + checkoff.getUniqueId()) != null
						...
						API.sendMsg(jogador, "§7Mutado por: §5§l"
						...
						API.sendMsg(jogador, "§7Data do mute: §e"
					...
					if (Config.getConfig().getMute().get("Mute." + checkoff.getUniqueId()) == null
						...
						API.sendMsg(jogador, "§7Mutado por: §5§l" + Config.getConfig().getTempMute()
								.get("TempMute." + checkoff.getUniqueId() + ".Mutado por"));
						API.sendMsg(jogador, "§7Motivo: §6§l" + Config.getConfig().getTempMute()
								.get("TempMute." + checkoff.getUniqueId() + ".Motivo"));
						API.sendMsg(jogador, "§7Expira em: §a" + Config.getConfig().getTempMute()
								.get("TempMute." + checkoff.getUniqueId() + ".Tempo do Mute"));
						API.sendMsg(jogador, "§7Data do mute: §e" + Config.getConfig().getTempMute()
			...
			if (Config.getConfig().getMute().get("Mute." + check.getUniqueId()) != null
				...
				API.sendMsg(jogador, "§7Data do mute: §a"
