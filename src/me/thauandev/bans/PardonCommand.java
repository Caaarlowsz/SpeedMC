	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (cmd.getName().equalsIgnoreCase("pardon")) {
			...
			if (args[0].equalsIgnoreCase("ban")) {
				if (args.length == 1) {
					API.sendMsg(jogador,
							"§c§lSPEED§f§lMC §fUtilize §c/pardon (ban) (ipban) (mute) (tempmute) (jogador) ");
					return true;
				}
				...
				if (!(sender instanceof Player)) {
					...
					API.sendStaff(
							"§c§lSPEED§f§lMC §f" + jogador.getName() + " desbaniu o jogador: §b" + vitima.getName());
				}
			...
			if (args[0].equalsIgnoreCase("tempban")) {
				...
				if (!(sender instanceof Player)) {
					...
					API.sendMsg(jogador, "§c§lSPEED§f§lMC §fVocê desbaniu o jogador: §b" + vitima.getName());
					API.sendStaff(
							"§c§lSPEED§f§lMC §f" + jogador.getName() + " §fdesbaniu o jogador: §b" + vitima.getName());
				}
			...
			if (args[0].equalsIgnoreCase("mute")) {
				...
				if (vitima == null) {
					...
					if (!(sender instanceof Player)) {
						...
						API.sendStaff("§c§lSPEED§f§lMC §f" + jogador.getName() + " desmutou o jogador: §c§"
								+ vitimaoff.getName());
					}
				...
				if (!(sender instanceof Player)) {
					...
					API.sendStaff(
							"§c§lSPEED§f§lMC §f" + jogador.getName() + " desmutou o jogador: §c§l" + vitima.getName());
				}
			...
			if (args[0].equalsIgnoreCase("tempmute")) {
				...
				if (!(sender instanceof Player)) {
					...
					API.sendStaff(
							"§c§lSPEED§f§lMC §f" + jogador.getName() + " desmutou o jogador: §c" + vitima.getName());
				}
