...
public class WarpsMenu {
	...
	public static void inventory(Player p){
		...
		menu.setItem(23, criarItemMenu(Material.LAVA_BUCKET, "§bLavaChallenge", new String[] {"§7Tanquem até a ultima."}));
		menu.setItem(30, criarItemMenu(Material.STICK, "§bKnockBack", new String[] {"§7Vença seu inimigo usando seu Stick Magico."}));
		menu.setItem(31, criarItemMenu(Material.POTION, "§bMain", new String[] {"§7Lutem com suas forças."}));
		menu.setItem(32, criarItemMenu(Material.FISHING_ROD, "§bFisherman", new String[] {"§7Pesquem seus inimigos."}));
