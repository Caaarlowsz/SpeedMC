...
public class LojaVips {
	...
	public static void inventory(Player p) {
		...
		menu.setItem(2, criarItemMenu(Material.EMERALD_BLOCK, "§a§lLIGHT",
		...
		menu.setItem(4,
				criarItemMenu(Material.GOLD_BLOCK, "§6§lPREMIUM",
						new String[] { " ", "                   §7◿ §7§lBeneficios §7◿",
								"§7- §7§lSLOT EXCLUSIVO EM NOSSO SERVIDOR",
								"§7- §7§lTAG §a§lLIGHT §7e §6§lPREMIUM §7§lPARA SER DIFRENCIADO",
								"§7- §7§lACESSO A 16 KITS DO SERVIDOR", " " }));
		menu.setItem(6,
				criarItemMenu(Material.PORTAL, "§d§lULTIMATE",
						new String[] { " ", "                   §7◿ §7§lBeneficios §7◿",
								"§7- §7§lSLOT EXCLUSIVO EM NOSSO SERVIDOR",
								"§7- §7§lTAG §a§lLIGHT§7, §6§lPREMIUM §7e §d§lULTIMATE §7§lPARA SER DIFRENCIADO",
