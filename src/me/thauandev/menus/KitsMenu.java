...
public class KitsMenu {
	...
	public static void inventory(Player p) {
		...
		if ((cfGrupo.ChecarGrupo(p, "Membro")
				|| (cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Builder")))
				|| (cfGrupo.ChecarGrupo(p, "Helper") || (cfGrupo.ChecarGrupo(p, "Light") || (cfGrupo.ChecarGrupo(p,
						"S-Pro")
						|| (cfGrupo.ChecarGrupo(p, "Mvp") || (cfGrupo.ChecarGrupo(p, "Pro") || (cfGrupo.ChecarGrupo(p,
								"Youtuber")
								|| (cfGrupo.ChecarGrupo(p, "Trial") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo
										.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(18, criarItemMenu(Material.STONE_SWORD, "§bPvP", new String[] {
					"§9§lHABILIDADE: §7Derrote seus adversários ", "§7utilizando sua espada avançada" }));
		}
		if ((cfGrupo.ChecarGrupo(p, "Membro") || (cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Light")
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(19, criarItemMenu(Material.FIREWORK, "§bKangaroo",
					new String[] { "§9§lHABILIDADE: §7Dê saltos como um", "§7canguru utilizando seu item" }));
		}
		if ((cfGrupo.ChecarGrupo(p, "Membro")
				|| (cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Builder")))
				|| (cfGrupo.ChecarGrupo(p, "Helper") || (cfGrupo.ChecarGrupo(p, "Light") || (cfGrupo.ChecarGrupo(p,
								...
								|| (cfGrupo.ChecarGrupo(p, "Trial") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo
										...
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(20, criarItemMenu(Material.FISHING_ROD, "§bFisherman",
					new String[] { "§9§lHABILIDADE: §7Pesque o seu adversário e faça estratégias!" }));
		}
		if ((cfGrupo.ChecarGrupo(p, "Membro") || (cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Light")
				|| (cfGrupo.ChecarGrupo(p, "S-Pro") || (cfGrupo.ChecarGrupo(p, "Mvp") || (cfGrupo.ChecarGrupo(p, "Pro")
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Trial")
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(21, criarItemMenu(Material.ARROW, "§bMiniGun",
					new String[] { "§9§lHABILIDADE: §7Encha seus inimigos", "§7de flecha com um click!" }));
		}
		if ((cfGrupo.ChecarGrupo(p, "Membro")
				|| (cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Builder")))
				|| (cfGrupo.ChecarGrupo(p, "Helper") || (cfGrupo.ChecarGrupo(p, "Light") || (cfGrupo.ChecarGrupo(p,
								...
								|| (cfGrupo.ChecarGrupo(p, "Trial") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo
										...
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(22, criarItemMenu(Material.ANVIL, "§bAnchor",
					new String[] { "§9§lHABILIDADE: §7Não Tome, e não de KnockBack!" }));
		}
		if ((cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Builder"))) || (cfGrupo.ChecarGrupo(p,
				"Helper")
				|| (cfGrupo.ChecarGrupo(p, "Light") || (cfGrupo.ChecarGrupo(p, "S-Pro") || (cfGrupo.ChecarGrupo(p,
						"Mvp")
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))))))) {
			menu.setItem(27, criarItemMenu(Material.CACTUS, "§bCactus",
					new String[] { "§9§lHABILIDADE: §7Vire um cacto e", "§7espete seus inimigos!" }));
		}
		if (cfGrupo.ChecarGrupo(p, "Membro") || (cfGrupo.ChecarGrupo(p, "Winner") || (cfGrupo.ChecarGrupo(p, "Light")
				|| (cfGrupo.ChecarGrupo(p, "S-Pro") || (cfGrupo.ChecarGrupo(p, "Mvp") || (cfGrupo.ChecarGrupo(p, "Pro")
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Trial")
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))))))) {
			menu.setItem(24, criarItemMenu(Material.BLAZE_ROD, "§bMonk",
					new String[] { "§9§lHABILIDADE: §7Faça alterações no inventário", "§7dos seus oponentes!" }));
		}
		if (cfGrupo.ChecarGrupo(p, "Membro") || (cfGrupo.ChecarGrupo(p, "Winner")
				|| (cfGrupo.ChecarGrupo(p, "Light") || (cfGrupo.ChecarGrupo(p, "Builder")))
				|| (cfGrupo.ChecarGrupo(p, "Helper") || (cfGrupo.ChecarGrupo(p, "Light") || (cfGrupo.ChecarGrupo(p,
						"S-Pro")
						|| (cfGrupo.ChecarGrupo(p, "Mvp") || (cfGrupo.ChecarGrupo(p, "Pro") || (cfGrupo.ChecarGrupo(p,
								"Youtuber")
								|| (cfGrupo.ChecarGrupo(p, "Trial") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo
										...
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(25, criarItemMenu(Material.BOW, "§bArcher",
					new String[] { "§9§lHABILIDADE: §7Acabe com os oponentes usando", "§7seu arco!" }));
		}
		if (cfGrupo.ChecarGrupo(p, "Membro") || (cfGrupo.ChecarGrupo(p, "Winner") || cfGrupo.ChecarGrupo(p, "Light")
				|| (cfGrupo.ChecarGrupo(p, "S-Pro") || (cfGrupo.ChecarGrupo(p, "Mvp") || (cfGrupo.ChecarGrupo(p, "Pro")
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Trial")
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))) {
			menu.setItem(26, criarItemMenu(Material.ENCHANTED_BOOK, "§bSpecialist",
					new String[] { "§9§lHABILIDADE: §7Tenha uma mesa", "§7de encantamento portatil!" }));
		}
		if (cfGrupo.ChecarGrupo(p, "Membro") || (cfGrupo.ChecarGrupo(p, "Winner") || cfGrupo.ChecarGrupo(p, "Light")
				|| (cfGrupo.ChecarGrupo(p, "S-Pro") || (cfGrupo.ChecarGrupo(p, "Mvp") || (cfGrupo.ChecarGrupo(p, "Pro")
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Trial")
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))) {
			menu.setItem(23, criarItemMenu(Material.DIAMOND_CHESTPLATE, "§bTurtle",
					new String[] { "§9§lHABILIDADE: §7Aperte shift e", "§7leve menos dano!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(28, criarItemMenu(Material.COMPASS, "§bNinja", new String[] {
					"§9§lHABILIDADE: §7Teleporte-se até o", "§7último jogador hitado clicando Shift!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(29, criarItemMenu(Material.GOLD_HELMET, "§bAntiTower", new String[] {
					"§9§lHABILIDADE: §7Não leve dano de queda, não tome dano seja morto por stomper, não seja puxado por endermage!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))))))) {
			menu.setItem(30, criarItemMenu(Material.FEATHER, "§bPhantom",
					new String[] { "§9§lHABILIDADE: §7Utilize sua pena para", "§7voar como um pássaro!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))))))) {
			menu.setItem(31, criarItemMenu(Material.LEASH, "§bGrappler",
					new String[] { "§9§lHABILIDADE: §7Escale paredes utilizando", "§7sua corda mágica!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))))))) {
			menu.setItem(32, criarItemMenu(Material.SPIDER_EYE, "§bViper",
					new String[] { "§9§lHABILIDADE: §7Aplique veneno em seus", "§7adversários ao entra em combate!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
										|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
												|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
														|| GiveAllCommand.fullkit || GiveAllCommand.light
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))))))) {
			menu.setItem(33, criarItemMenu(Material.STRING, "§bSnail",
					new String[] { "§9§lHABILIDADE: §7Aplique lentidão profunda", "§7e ganhe vantagem!" }));
		}
								...
								|| (cfGrupo.ChecarGrupo(p, "Mod+") || (cfGrupo.ChecarGrupo(p, "Gerente")
										|| (cfGrupo.ChecarGrupo(p, "Youtuber+") || (cfGrupo.ChecarGrupo(p, "Admin")
												|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))) {
			menu.setItem(34, criarItemMenu(Material.SADDLE, "§bHulk",
					new String[] { "§9§lHABILIDADE: §7Puxe seus inimigos para cima", "§7e os detenha!" }));
		}
						...
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod")
								|| (cfGrupo.ChecarGrupo(p, "Mod+") || (cfGrupo.ChecarGrupo(p, "Gerente")
										|| (cfGrupo.ChecarGrupo(p, "Youtuber+") || (cfGrupo.ChecarGrupo(p, "Admin")
												|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit
														|| GiveAllCommand.mvp || GiveAllCommand.pro))))))))))) {
			menu.setItem(35, criarItemMenu(Material.WATCH, "§bTimelord",
					new String[] { "§9§lHABILIDADE: §7Congele os players de", "§7sua volta" }));
		}
						...
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod")
								|| (cfGrupo.ChecarGrupo(p, "Mod+") || (cfGrupo.ChecarGrupo(p, "Gerente")
										|| (cfGrupo.ChecarGrupo(p, "Youtuber+") || (cfGrupo.ChecarGrupo(p, "Admin")
												|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))) {
			menu.setItem(36, criarItemMenu(Material.WOOD_AXE, "§bThor",
					new String[] { "§9§lHABILIDADE: §7Vire o thor e lançe raios", "§7em seus inimigos" }));
		}
						...
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod")
								|| (cfGrupo.ChecarGrupo(p, "Mod+") || (cfGrupo.ChecarGrupo(p, "Gerente")
										|| (cfGrupo.ChecarGrupo(p, "Youtuber+") || (cfGrupo.ChecarGrupo(p, "Admin")
												|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))) {
			menu.setItem(37, criarItemMenu(Material.SNOW_BALL, "§bSwitcher", new String[] {
					"§9§lHABILIDADE: §7Troque de lugar com seus inimigos ao", "§7acertar uma bola de neve nele" }));
		}
						...
						|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod")
								|| (cfGrupo.ChecarGrupo(p, "Mod+") || (cfGrupo.ChecarGrupo(p, "Gerente")
										|| (cfGrupo.ChecarGrupo(p, "Youtuber+") || (cfGrupo.ChecarGrupo(p, "Admin")
												|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit
														|| GiveAllCommand.mvp || GiveAllCommand.pro)))))))))) {
			menu.setItem(38, criarItemMenu(Material.IRON_FENCE, "§bGladiator",
					new String[] { "§9§lHABILIDADE: §7Puxe seus inimigos para um", "§7duelo nas alturas!" }));
		}
		if (((cfPermissão.getPermissao(p, "kit.stomper") || cfGrupo.ChecarGrupo(p, "Pro")
			...
			menu.setItem(39, criarItemMenu(Material.DIAMOND_BOOTS, "§bStomper", new String[] {
					"§9§lHABILIDADE: §7Transfira seu dano de", "§7queda para seus inimigos ao pular neles." }));
		}
				...
				|| (cfGrupo.ChecarGrupo(p, "Youtuber")
						|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
								|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
										|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
												|| GiveAllCommand.fullkit || GiveAllCommand.pro)))))))))) {
			menu.setItem(40, criarItemMenu(Material.FIRE, "§bMagma",
					new String[] { "§9§lHABILIDADE: §7Receba 30% de chance de queimar", "§7seus inimigos!" }));
		}
				...
				|| (cfGrupo.ChecarGrupo(p, "Youtuber")
						|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
								|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
										|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
												|| GiveAllCommand.fullkit || GiveAllCommand.pro)))))))))) {
			menu.setItem(41, criarItemMenu(Material.STICK, "§bGrandpa",
					new String[] { "§9§lHABILIDADE: §7Jogue seus inimigos para longe", "§7utilizando seu graveto!" }));
		}
				...
				|| (cfGrupo.ChecarGrupo(p, "Youtuber")
						|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
								|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
										|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
												|| GiveAllCommand.fullkit || GiveAllCommand.pro)))))))))) {
			menu.setItem(42, criarItemMenu(Material.NETHER_STAR, "§bAjnin",
					new String[] { "§9§lHABILIDADE: §7Puxe o último jogador hitado", "§7até você clicando shift!" }));
		}
				...
				|| (cfGrupo.ChecarGrupo(p, "Youtuber")
						|| (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p, "Mod+")
								|| (cfGrupo.ChecarGrupo(p, "Gerente") || (cfGrupo.ChecarGrupo(p, "Youtuber+")
										|| (cfGrupo.ChecarGrupo(p, "Admin") || (cfGrupo.ChecarGrupo(p, "Dono")
												|| GiveAllCommand.fullkit || GiveAllCommand.pro)))))))))) {
			menu.setItem(43, criarItemMenu(Material.FIREBALL, "§bFirelauncher",
					new String[] { "§9§lHABILIDADE: §7Utilize a sua habilidade para", "§7queimar seus inimigos" }));
		}
		if (((cfPermissão.getPermissao(p, "kit.endermage") || cfGrupo.ChecarGrupo(p, "Pro")
				|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p,
						"Admin") || cfGrupo.ChecarGrupo(p, "Helper") || cfGrupo.ChecarGrupo(p, "Builder")
						|| cfGrupo.ChecarGrupo(p, "Youtuber+") || cfGrupo.ChecarGrupo(p, "Mod+")
						|| cfGrupo.ChecarGrupo(p, "Gerente")
						|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit || GiveAllCommand.pro))))))) {
			menu.setItem(44, criarItemMenu(Material.getMaterial(120), "§bEndermage",
					new String[] { "§9§lHABILIDADE: §7Puxe Quem estiver embaixo ou acima de voçê!" }));
		}
		if (((cfPermissão.getPermissao(p, "kit.strong") || cfGrupo.ChecarGrupo(p, "Pro")
				|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p,
						...
						|| cfGrupo.ChecarGrupo(p, "Gerente")
						|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit || GiveAllCommand.pro))))))) {
			menu.setItem(45, criarItemMenu(Material.WATCH, "§bStrong",
					new String[] { "§9§lHABILIDADE: §7Fi	que Full Iron por alguns instantes!" }));
		}
		if (((cfPermissão.getPermissao(p, "kit.sumo") || cfGrupo.ChecarGrupo(p, "Helper")
				...
				|| (cfGrupo.ChecarGrupo(p, "Youtuber") || (cfGrupo.ChecarGrupo(p, "Mod") || (cfGrupo.ChecarGrupo(p,
						"Admin")
						|| (cfGrupo.ChecarGrupo(p, "Dono") || GiveAllCommand.fullkit || GiveAllCommand.pro))))))) {
			menu.setItem(46, criarItemMenu(Material.APPLE, "§bSumo",
					new String[] { "§9§lHABILIDADE: §7Jogue seus inimigos", "§7para o alto utilizando seu peso" }));
		}
