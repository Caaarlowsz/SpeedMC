...
public class PacketPlayOut {
	...
	@SuppressWarnings("rawtypes")
	PacketPlayOut(String name, Collection players, int paramInt) throws ClassNotFoundException, IllegalAccessException,
	...
	private static String getPacketTeamClasspath() {
		if ((Integer.valueOf(version.split("_")[1]).intValue() < 7)
				&& (Integer.valueOf(version.toLowerCase().split("_")[0].replace("v", "")).intValue() == 1)) {
